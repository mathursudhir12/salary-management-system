 ...
 *
 * All custom forwardRef wrappers are wrapped with React.memo.
 * Plain Radix re-exports (Dialog, DialogTrigger, DialogPortal, DialogClose)
 * are already memoised by Radix internally and are left as-is.
 */
  ...
  >(({ className, children, ...props }, ref) => (
    <DialogPortal>
      ...
      >
        ...
        >
          {/* Inline X icon — no icon library needed */}
          <svg
